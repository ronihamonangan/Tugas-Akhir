...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(315, 31);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(215, 37);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Masukkan data ";
			// 
			// textBox1
			// 
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Calibri", 16.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(448, 188);
			...
			this->label2->Location = System::Drawing::Point(256, 187);
			...
			this->label3->Location = System::Drawing::Point(265, 260);
			this->label3->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(151, 37);
			...
			// textBox2
			// 
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Calibri", 16.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(448, 260);
			this->textBox2->Margin = System::Windows::Forms::Padding(4);
			this->textBox2->Name = L"textBox2";
			this->textBox2->PasswordChar = '*';
			this->textBox2->Size = System::Drawing::Size(340, 40);
			...
			this->button1->Location = System::Drawing::Point(553, 352);
			...
			this->label4->Location = System::Drawing::Point(256, 69);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(325, 37);
			this->label4->TabIndex = 7;
			this->label4->Text = L"Username dan Password";
			this->label4->Click += gcnew System::EventHandler(this, &Login::label4_Click);
			// 
			// pictureBox1
			// 
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(48, 146);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(201, 212);
			...
			this->ClientSize = System::Drawing::Size(824, 455);
			...
			this->Name = L"Login";
			this->Text = L"Aplikasi Perhitungan Gaji - Login";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			MessageBox::Show("Input your username. Please..", "Warning", MessageBoxButtons::OK, MessageBoxIcon::Warning);
		}
		else {
			if (this->textBox2->Text->Equals("")) {
				MessageBox::Show("Input your password. Please..", "Warning", MessageBoxButtons::OK, MessageBoxIcon::Warning);
			}
			else {
				if (this->textBox1->Text->Equals("Indah Makmur,. Tbk")) {
					if (this->textBox2->Text->Equals("tobenice123"))
					{
						this->Hide();
						Perhitungan^ perhitungan = gcnew Perhitungan();
						perhitungan->Show();
					}
					else {
